...
set(USE_SYCL /home/wzy/sycl_workspace/build-hip-2022-09-log-debug)
...
if(IS_DIRECTORY ${USE_SYCL})
    ...
    elseif (DEFINED USE_SYCL_HIP)
        add_definitions(-DSYCL_FLAGS=" -std=c++17 -O3  -fsycl -fsycl-targets=${USE_SYCL_HIP}   -fPIC -shared -Wno-sycl-target -Wno-linker-warnings ")
...
#set(USE_OPENCL OFF)
set(USE_OPENCL /opt/rocm/opencl)
